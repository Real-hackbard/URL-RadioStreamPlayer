...
begin
   ...
   DSP_Plugin := GetProgDir + 'Data\Plugins\DSP\' + PluginList.Items[IndexNum];
...
begin
   ...
   if FindFirst(GetProgDir + 'Data\Plugins\DSP\*.dll', 0, SearchRec) = 0 then
   begin
...
begin
   ...
   BassPlayer1.RunDSPPlugin(GetProgDir + 'Data\Plugins\DSP\' + PluginList.Items[IndexNum],
